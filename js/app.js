...
// Validar
  ...
  if(ciudad === "" || pais === "") {
    // Hubo un error
    mostrarError('Ambod campos son obligatorios');
...
function consultarAPI(ciudad, pais ) {
  const appdID = "3c20324c244f4b779605fe9668ecf9aa";

  const url = `https://api.openweathermap.org/data/2.5/weather?q=${ciudad},${pais}&appid=${appdID}`;

  Spinner(); // Muestra spinner al buscar 
...
nameCity.classList.add( 'text-6xl');
